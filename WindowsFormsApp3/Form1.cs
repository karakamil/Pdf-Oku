...
namespace WindowsFormsApp3
{
    public class Form1 : Form
    {
       ...
       //referanslar klasına 
        ...
        public Form1()
        {
            //PdfOku oku = new PdfOku();
            //oku.Baglanti = "cxfgdfgdfg";
            //oku.DosyaOkumayaBasla();
        ...
        private void DosyaOkumayaBasla()//public olacak
        {
            ...
            Form1.HizmetListesiniKaydet(this.HList);
            if (Form1.SilinecekIptalKayitlar.Count > 0)
                Form1.KayitIptalSil();
        ...
        {
            using (SQLiteConnection sqlConnection = Form1.ConnectionVer())
            {
                ...
                foreach (IptalKayitlar iptalKayitlar in Form1.SilinecekIptalKayitlar)
                {
            ...
            using (SQLiteConnection sqlConnection = Form1.ConnectionVer())
            {
                ...
                foreach (PdfHizmetListesi pdfHizmetListesi in HL)
                {
                    ...
                    sqlCommand.CommandText = "Insert Into HizmetListesi (KurumID,Year,Month,SgkNo,Ad,Soyad,IlkSoyad,Ucret,Ikramiye," +
                                             "Gun,Eksik_Gun,GGun,CGun,Egs,Icn,Meslek_Kodu,Kanun_No,Belge_Cesidi,Belge_Turu,OnayBekleyen,Mahiyet,UCG)VALUES (@KURUMID,@YEAR,@MONTH,@SGKNO,@AD,@SOYAD,@ILKSOYAD,@UCRET,@IKRAMIYE,@GUN,@EKSIK_GUN,@GGUN,@CGUN,@EGS,@ICN,@MESLEK_KODU,@KANUN_NO,@BELGE_CESIDI,@BELGETURU,@ONAYBEKLEYEN,@MAHIYET,@UCG)";
                    ...
                    sqlCommand.Parameters.AddWithValue("@MONTH", (object)Convert.ToInt32(pdfHizmetListesi.Donem.Split('/')[1].ToString().Trim()));
                    ...
                    if (pdfHizmetListesi.Mahiyet == "IPTAL")
                        Form1.KayitIptalListeEkle(Convert.ToInt32(pdfHizmetListesi.Donem.Split('/')[0].Trim()), Convert.ToInt32(pdfHizmetListesi.Donem.Split('/')[1].Trim()), pdfHizmetListesi.SgkNo, pdfHizmetListesi.KanunNo, pdfHizmetListesi.CGun, pdfHizmetListesi.GGun, pdfHizmetListesi.Ucret);
                    ++num1;
                }
            }
        }
        ...
        private string ExtractTextFromPDFBytes(byte[] input)
        {
            ...
            try
            {
                ...
                bool flag2 = false;
                int num1 = 0;
                char[] recent = new char[Form1._numberOfCharsToKeep];
                for (int index = 0; index < Form1._numberOfCharsToKeep; ++index)
                    recent[index] = ' ';
                ...
                "\""
                    ...
                    for (int index2 = 0; index2 < Form1._numberOfCharsToKeep - 1; ++index2)
                        recent[index2] = recent[index2 + 1];
                    recent[Form1._numberOfCharsToKeep - 1] = ch;
                    int num3;
                    if (!flag1)
        ...
        private bool CheckToken(string[] tokens, char[] recent)
        {
            ...
            {
                if ((int)recent[Form1._numberOfCharsToKeep - 3] == (int)token[0] && (int)recent[Form1._numberOfCharsToKeep - 2] == (int)token[1] && (recent[Form1._numberOfCharsToKeep - 1] == ' ' || recent[Form1._numberOfCharsToKeep - 1] == '\r' || recent[Form1._numberOfCharsToKeep - 1] == '\n') && (recent[Form1._numberOfCharsToKeep - 4] == ' ' || recent[Form1._numberOfCharsToKeep - 4] == '\r' || recent[Form1._numberOfCharsToKeep - 4] == '\n'))
                    return true;
            }
            return false;
        }
        ...
        private static SQLiteConnection ConnectionVer()
        {
            ...
            //sqlConnection.ConnectionString = Baglanti;//ConfigurationManager.AppSettings["Baglanti"];
            try
            {
          ...
          string Maas)
        {
            ...
            Form1.SilinecekIptalKayitlar.Add(iptalKayitlar);
        }

        private void button1_Click(object sender, EventArgs e)
        {
            this.DosyaOkumayaBasla();
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.SuspendLayout();
            this.button1.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f, FontStyle.Bold, GraphicsUnit.Point, (byte)162);
            this.button1.ForeColor = Color.Maroon;
            this.button1.Location = new Point(12, 44);
            this.button1.Name = "button1";
            this.button1.Size = new Size(168, 23);
            this.button1.TabIndex = 0;
            this.button1.Text = "PDF Dosyalarını Oku";
            this.button1.UseVisualStyleBackColor = true;
            this.button1.Click += new EventHandler(this.button1_Click);
            this.linkLabel1.AutoSize = true;
            this.linkLabel1.Location = new Point(9, 134);
            ...
            this.ClientSize = new Size(191, 156);
